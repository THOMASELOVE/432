...
2. Download and install **RStudio Desktop** (Open Source Edition - the free version **1.4.1103 or later**) at https://www.rstudio.com/products/rstudio/download/#download. 
    - Dr. Love strongly recommends upgrading to version 1.4 of RStudio. [Read RStudio's announcement about the release](https://blog.rstudio.com/2021/01/19/announcing-rstudio-1-4/).
...
4. Download [432 data and code](data_index.html) developed specifically for the course.
...
We have an [R-basics set of materials](https://github.com/THOMASELOVE/432-2021/tree/master/r-basics) that may be helpful for those of you having trouble remembering how to use R to do useful things.
